...
export const en: Record<string, string> = {
  ...
  "onboarding.location.hint": "Tap to detect your city",
  "onboarding.location.detected": "City: {city}",
  ...
  "onboarding.budget.subtitle": "Drag the range — we'll match meals between these amounts (30–300 SAR).",
